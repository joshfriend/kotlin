...
internal class PropertiesProvider private constructor(private val project: Project) {
    ...
    val publishJsCompilerAttribute: Boolean
        get() {
            ...
            val jsCompilerProperty = org.jetbrains.kotlin.gradle.plugin.KotlinJsCompilerType.jsCompilerProperty
            return this.booleanProperty("$jsCompilerProperty.publish.attribute") ?: true
        }
    ...
    object PropertyNames {
        ...
        val KOTLIN_METADATA_RUN_COMPILER_VIA_BUILD_TOOLS_API = property("kotlin.metadata.compiler.runViaBuildToolsApi")
        ...
        val KOTLIN_APPLE_CREATE_SYMBOLIC_LINK_TO_FRAMEWORK_IN_BUILT_PRODUCTS_DIR =
    ...
    companion object {
        ...
        internal const val ABI_VALIDATION_BANNED_TARGETS_NAME =
            "$KOTLIN_INTERNAL_NAMESPACE.abi.validation.klib.targets.disabled.for.testing"
