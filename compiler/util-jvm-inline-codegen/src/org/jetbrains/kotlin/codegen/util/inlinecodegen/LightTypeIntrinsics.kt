...
//                    "null cannot be cast to non-null type " + DescriptorRenderer.FQ_NAMES_IN_TYPES.renderType(type),
                    "null cannot be cast to non-null type <TODO: renderType>",
                    emit,
                )
                emit(nonnullLbl)
            }
...
private fun ((AbstractInsnNode) -> Unit).typeIntrinsic(methodName: String, descriptor: String) =
    this(MethodInsnNode(Opcodes.INVOKESTATIC, LightTypeIntrinsics.INTRINSICS_CLASS, methodName, descriptor, false))
