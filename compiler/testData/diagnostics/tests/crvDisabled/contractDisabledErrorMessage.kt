...
inline fun <T, R> T.myLet(block: (T) -> R): R {
    contract {
        ...
        <!ERROR_IN_CONTRACT_DESCRIPTION("requires language features '-XXLanguage:+AllowReturnsResultOfContract', '-Xreturn-value-checker' to be enabled")!>returnsResultOf(block)<!>
    }
    return block(this)
}
