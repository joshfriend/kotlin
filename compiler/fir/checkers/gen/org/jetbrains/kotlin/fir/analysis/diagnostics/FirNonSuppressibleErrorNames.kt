...
val FIR_NON_SUPPRESSIBLE_ERROR_NAMES: Set<String> = setOf(
    ...
    "PARENTHESIZED_PACKAGE_QUALIFIER_ERROR",
    ...
    "JS_FAKE_NAME_CLASH",
    "JS_SYMBOL_ON_TOP_LEVEL_DECLARATION",
    "JS_SYMBOL_PROHIBITED_FOR_OVERRIDE",
    "WRONG_JS_QUALIFIER",
    ...
    "VALUE_CLASS_CANNOT_EXTEND_IDENTITY_CLASSES",
    ...
    "IMPOSSIBLE_IS_CHECK_RELYING_ON_NULL_ERROR",
    "IS_ENUM_ENTRY",
    "DYNAMIC_NOT_ALLOWED",
    "ENUM_ENTRY_AS_TYPE",
    "EXPECTED_CONDITION",
    ...
    "EXPOSED_NOT_EXPORTED_SUPER_INTERFACE_ERROR",
    "NESTED_JS_EXPORT",
