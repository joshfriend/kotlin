...
value class Bounded1<T: Bounded1<T>>(val x: <!VALUE_CLASS_CANNOT_BE_RECURSIVE!>T<!>)
value class Bounded2<T: Bounded2<T>>(val x: T?)
value class Bounded3<T: Bounded3<T>>(val x: <!VALUE_CLASS_CANNOT_BE_RECURSIVE!>T<!>, val y: <!VALUE_CLASS_CANNOT_BE_RECURSIVE!>T<!>)
