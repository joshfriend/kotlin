...
private const val K_TYPE_PROJECTION_COMPANION = "kotlin/reflect/KTypeProjection\$Companion"
...
private fun generateTypeOfArgument(
    ...
    emit(FieldInsnNode(Opcodes.GETSTATIC, K_TYPE_PROJECTION, "Companion", "L$K_TYPE_PROJECTION_COMPANION;"))

    when (projection) {
        is LightIrType.TypeArgument.StarProjection -> {
            emit.methodInsnNode(Opcodes.INVOKEVIRTUAL, K_TYPE_PROJECTION_COMPANION, "getSTAR", "()L$K_TYPE_PROJECTION;")
        }
