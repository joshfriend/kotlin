...
enum class LanguageFeature(
    ...
    ForbidImplementationByDelegationWithDifferentGenericSignature(KOTLIN_2_3, enabledInProgressiveMode = true, "KTLC-267"),
    ...
    JvmIndyAllowLambdasWithAnnotations(KOTLIN_2_3, "KTLC-278"),
    ...
    ProperExhaustivenessCheckForJavaOpenSealedClass(sinceVersion = KOTLIN_2_4, enabledInProgressiveMode = true,"KTLC-366"),
    ...
    PropertyParamAnnotationDefaultTargetMode(sinceVersion = KOTLIN_2_4, "KT-73255"),
    AnnotationAllUseSiteTarget(sinceVersion = KOTLIN_2_4, "KT-73256"),
    ...
    // When stabilizing this feature, also set `sinceVersion` of `ProhibitCallableReferencesToStaticsWithTypeArgumentsOrNullMarkInLhs` to the next one
    ...
    ProhibitCallableReferencesToStaticsWithTypeArgumentsOrNullMarkInLhs(sinceVersion = null, issue = "KT-84956"),
